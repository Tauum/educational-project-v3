...
export default function ExtrasModeration() {
    ...
    async function fetchData() {
        setParentToChildData(await baseGetRequest("Extras/withoutModule"))
    }
