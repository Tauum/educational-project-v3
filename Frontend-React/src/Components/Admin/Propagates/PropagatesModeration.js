...
export default function PropagatesModeration() {
    ...
    async function fetchData() {
        setParentToChildData(await baseGetRequest("Propagates/withoutModule"))
    }
