...
public class Module {
    ...
    @ManyToMany
    @JoinTable(name="module_shifters",
            joinColumns = @JoinColumn(name="module_id"),
            inverseJoinColumns =  @JoinColumn(name = "shifter_id")
    )
    ...
    public Module(String code, Set<User> students, Set<User> admins, List<Quiz> quizzes, List<Hangman> hangmen, List<Extra> extras, List<Shifter> shifters, List<Feedback> feedbacks, List<Swipe> swipes, @Nullable String description) {
        this.code = code;
        this.students = students;
        this.admins = admins;
    ...
    public Module(String code, String name, List<Quiz> quizzes, List<Hangman> hangmen, List<Extra> extras, List<Shifter> shifters, List<Feedback> feedbacks, List<Swipe> swipes) {
        this.code = code;
        this.name = name;
        this.quizzes = quizzes;
        this.hangmen = hangmen;
